...
const Register = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (password !== confirmPassword) {
      // You would typically handle this through your notification system
      return;
    }
    try {
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ maxWidth: 600 }}>
            Join thousands of businesses using GeoQualified Pro to transform their lead management process with AI-powered personalization and comprehensive campaign management tools.
          </Typography>
        </Box>
      </Grid>
